...
def test_knn_ratio_scores_member_like_points_higher() -> None:
    ...
    attack = KNNDistanceRatioMembershipInference(k=2).fit(shadow_members, shadow_non_members)
...
def test_knn_ratio_tpr_at_fpr_is_bounded() -> None:
    ...
    attack = KNNDistanceRatioMembershipInference(k=1).fit(shadow_members, shadow_non_members)
