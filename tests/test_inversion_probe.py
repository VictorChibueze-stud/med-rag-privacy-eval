...
def test_linear_probe_reconstructs_known_tokens() -> None:
    texts = ['patient reports fever cough', 'doctor recommends rest hydration', 'patient has rash itching', 'blood pressure is elevated', 'nausea improves with fluids', 'joint pain needs follow up']
