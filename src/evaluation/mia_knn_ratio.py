...
class KNNDistanceRatioMembershipInference:
    ...
    def fit(self, shadow_member_embeddings: np.ndarray, shadow_non_member_embeddings: np.ndarray) -> 'KNNDistanceRatioMembershipInference':
        members = self._as_2d_float('shadow_member_embeddings', shadow_member_embeddings)
        non_members = self._as_2d_float('shadow_non_member_embeddings', shadow_non_member_embeddings)
        ...
        self._non_member_nn = NearestNeighbors(n_neighbors=self._non_member_k, metric='euclidean')
